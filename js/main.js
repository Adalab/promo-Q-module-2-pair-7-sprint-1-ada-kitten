...
'<li class="card">
            <article>
              <><img class="card_img" src="https://ychef.files.bbci.co.uk/976x549p07ryyyj.jpg" alt="gatito" /><h3class /></>"card_title">Anastacio</h3class=><><h4 class="card_race">British Shorthair</h4><p class="card_description">Ruiseño, juguetón, le guta estar tranquilo y que nadie le
...
<img
  ...
  alt="gatito"
/>
      <><h3 class="card_title">Fiona</h3><h4 class="card_race">British Shorthair</h4><p class="card_description">
